...
1. 요약: 현재 시장 상황을 초보자가 바로 이해할 수 있게 한 문장으로 설명한다.
2. 현재 상황: 가격 상승률, 거래량 증가, 변동성을 바탕으로 쉽게 설명한다.
3. 충동매수 위험: FOMO 가능성을 겁주지 말고 차분하게 설명한다.
4. 체크 질문: 사용자가 스스로 판단할 수 있도록 질문 3개를 한 줄에 제시한다.
5. 안내: “이 정보는 투자 추천이 아니라 매수 전 판단을 돕기 위한 참고 정보입니다.”라는 취지를 포함한다.
